...
namespace OneDrag
{
    ...
    public partial class App : Application
    {
        public App()
        {
            ...
            Version blurRequireVersion = new Version(10, 0, 14393, 0);
            Window showWindow;
            if (currentVersion >= blurRequireVersion)
            {
            ...
            {
                showWindow = new MainWindow_Compatible();
            }
            showWindow.Show();
        }
        ...
        {
            string Folder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\OneDrag\\CrashLog\\";
